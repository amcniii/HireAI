    ...
    <div className="dashboard">
      ...
      <main className="main">
        ...
        <header className="topbar">
          <div className="brand" style={{ cursor: "pointer" }} onClick={() => navigateToPage("Dashboard")}>
            <div className="brand-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <nav className="topbar-nav">
            <a onClick={() => navigateToPage("Dashboard")} className={activePage === "Dashboard" ? "active" : ""}>Home</a>
            <a onClick={() => navigateToPage("Jobs")} className={activePage === "Jobs" ? "active" : ""}>Jobs</a>
            <a onClick={() => navigateToPage("Candidates")} className={activePage === "Candidates" ? "active" : ""}>Candidates</a>
            <a onClick={() => navigateToPage("Compare")} className={activePage === "Compare" ? "active" : ""}>Compare</a>
            <a onClick={() => navigateToPage("Settings")} className={activePage === "Settings" ? "active" : ""}>Settings</a>
          </nav>

          <div className="topbar-right">
            <button className="appointment-btn" onClick={() => navigateToPage("Upload Resume")}>
              Upload Resume
            </button>
